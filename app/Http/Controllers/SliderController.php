...
class SliderController extends Controller
{
    ...
    public function index()
    {
        $sliders = Slider::all();
        $sn = 1;
        return view('slider.index', compact('sliders', 'sn'));
    }
        ...
        if ($photo != null) {
            ...
            if ($ext == 'jpg' || $ext == 'png') {
                if ($photo->move(public_path(), $fileName)) {
                    ...
                    return redirect()->back()->with('failed', 'Filed failed to upload, please check your internet ');
            ...
            $slider->image_url = $request->input('sliderImageUpdate');
            // $slider->save();
        }
        if ($slider->save()) {
