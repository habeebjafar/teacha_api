...
<head>
    ...
    <title>Techa Admin - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ URL::to('dashboard') }}">
                ...
                <div class="sidebar-brand-text mx-3">Teacha Admin</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ URL::to('add-department-form') }}">Add Deparments</a>
                        <a class="collapse-item" href="{{ URL::to('get-all-departments') }}">View Departments</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCourse" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                    <a class="dropdown-item" href="{{ URL::to('get-course-form') }}"> ADD COURSE</a>
                <a class="dropdown-item" href="{{ URL::to('get-all-courses') }}"> ALL COURSES </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTopic" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                    <a class="dropdown-item" href="{{ URL::to('get-topic-form') }}"> CREATE TOPIC</a>
                <a class="dropdown-item" href="{{ URL::to('get-all-topics') }}"> ALL TOPICS </a>
